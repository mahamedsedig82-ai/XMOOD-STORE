...
import { Plus, Edit2, Trash2, Loader2, Search, Box, Image as ImageIcon, Upload, Link as LinkIcon } from "lucide-react";
          ...
          <DialogContent className="max-w-4xl bg-zinc-950 border-primary/20 rounded-[2.5rem] p-10 text-white shadow-2xl overflow-y-auto max-h-[90vh] custom-scrollbar">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-10">
              ...
              <div className="col-span-1 md:col-span-2 space-y-4">
                 <label className="text-[10px] font-bold text-primary uppercase pr-3">إدارة صور المنتج</label>
                 ...
                 {form.imageUrl && (
                   <div className="relative w-full aspect-video rounded-3xl overflow-hidden border border-primary/20 shadow-2xl">
                      ...
                      <div className="absolute inset-0 bg-black/40 flex items-center justify-center opacity-0 hover:opacity-100 transition-opacity">
                         <span className="text-[10px] font-black uppercase tracking-widest bg-black/60 px-4 py-2 rounded-full">Product Image Preview</span>
                      </div>
                   </div>
                 )}
              </div>
                  ...
                  <TableCell className="py-8 pr-12" data-label="المنتج">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex flex-col">
                        <span className="text-xl font-bold text-white group-hover:gold-text transition-all">{p.name}</span>
                        <span className="text-[10px] text-primary/60 font-black uppercase tracking-widest mt-1">{p.category}</span>
                      </div>
                    </div>
                  </TableCell>
