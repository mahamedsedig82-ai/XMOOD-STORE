    ...
    <main className="min-h-screen bg-black font-body text-white" dir="rtl">
      ...
      <div className="container mx-auto px-6 py-32 animate-fade-up max-w-6xl">
        ...
        <header className="mb-16 flex flex-col md:flex-row justify-between items-center gap-10 border-b border-white/5 pb-16">
          <div className="flex items-center gap-8">
            ...
            <div className="text-right">
              ...
              <p className="text-zinc-500 font-medium text-lg mt-2">{profile?.fullName || "عضو بريميوم"}</p>
          ...
          <div className="flex flex-col gap-4 w-full md:w-auto items-end">
            ...
            <div className="flex items-center gap-3 text-green-500 bg-green-500/5 px-6 py-2 rounded-xl border border-green-500/20">
              <ShieldCheck size={16} />
              <span className="text-[10px] font-bold uppercase">حساب آمن 100%</span>
            </div>
          </div>
        </header>

        {isEditing && (
          <Card className="luxury-card border-none p-10 mb-16 animate-fade-in bg-zinc-950/40">
            <h3 className="text-2xl font-bold mb-10 gold-text flex items-center gap-3">
              <UserCheck size={24} /> تعديل الملف الشخصي
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="space-y-3">
                <label className="text-[9px] font-bold uppercase text-zinc-500 pr-4 tracking-widest">الاسم المعروض</label>
              ...
              <div className="space-y-3">
                <label className="text-[9px] font-bold uppercase text-zinc-500 pr-4 tracking-widest">رابط الصورة الشخصية</label>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          <Card className="luxury-card border-none relative overflow-hidden p-12 group bg-zinc-950">
            <div className="absolute top-0 right-0 w-80 h-80 bg-primary/5 blur-[100px] rounded-full group-hover:bg-primary/10 transition-all" />
          ...
          <Card className="lg:col-span-2 luxury-card border-none overflow-hidden p-12 flex flex-col md:flex-row items-center gap-12 bg-zinc-950">
            <div className="flex-1 space-y-8 text-right">
               <div className="flex items-center gap-4 text-primary">
                  ...
                  <h3 className="text-3xl font-bold gold-text">معرف الشحن (User ID)</h3>
               </div>
               <p className="text-zinc-500 font-medium leading-relaxed">
                  استخدم هذا المعرف الفريد لشحن رصيدك عبر الوكلاء المعتمدين أو لاستلام الحوالات من المستخدمين الآخرين.
               </p>
            ...
            <div className="w-full md:w-64 p-8 bg-black rounded-3xl text-center border border-white/5 shadow-2xl">
              <Heart size={32} className="text-red-600 mx-auto mb-4 fill-red-600" />
              <p className="text-xs font-bold text-zinc-400">حماية XMOOD الذكية</p>
              <p className="text-[8px] text-zinc-600 mt-2 uppercase tracking-widest">Active & Secured</p>
            </div>
          </Card>
        </div>

        <Card className="luxury-card border-none overflow-hidden bg-zinc-950/20">
          <CardHeader className="p-10 border-b border-white/5 flex flex-row items-center justify-between bg-zinc-950/40 backdrop-blur-xl">
            <CardTitle className="text-3xl font-bold flex items-center gap-5">
              <History size={32} className="text-red-500" /> سجل العمليات المالية
            </CardTitle>
            ...
            <Table>
              <TableHeader className="bg-black/40">
                <TableRow className="hover:bg-transparent border-none">
                  <TableHead className="text-right py-8 pr-12 font-bold uppercase text-[10px] text-zinc-600">الطرف الآخر / العملية</TableHead>
              ...
              <TableBody>
                {transLoading ? (
                      ...
                      <div className="flex items-center gap-5">
                        ...
                        <div className="flex flex-col">
                          <span className="font-bold text-lg text-white">
                            {t.type === 'transfer_send' ? t.targetUserName : t.senderUserName || "نظام المتجر"}
                          </span>
                  ...
                  <TableRow><TableCell colSpan={4} className="text-center py-40 opacity-20 font-bold text-3xl">لا توجد عمليات مسجلة</TableCell></TableRow>
                )}
              </TableBody>
            </Table>
          </CardContent>
