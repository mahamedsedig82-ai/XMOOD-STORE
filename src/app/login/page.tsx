    ...
    <main className="min-h-screen bg-background relative overflow-hidden" dir="rtl">
      ...
      <div className="fixed inset-0 pointer-events-none">
         ...
         <motion.div 
           ...
           className="absolute -bottom-1/4 -left-1/4 w-[800px] h-[800px] bg-primary/10 blur-[120px] rounded-full" 
         />
      </div>
      ...
      <div className="container mx-auto px-4 min-h-screen flex items-center justify-center pt-20 relative z-10">
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="w-full max-w-xl">
          <Card className="luxury-card border-none bg-card/40 backdrop-blur-3xl shadow-[0_50px_100px_-20px_rgba(0,0,0,0.3)]">
                    ...
                    {activeTab === 'login' ? (
                      <div className="space-y-8">
                        <div className="space-y-6">
                           <div className="space-y-2">
                              ...
                              <Input value={email} onChange={e => setEmail(e.target.value)} type="email" placeholder="example@xmood.com" className="h-16 text-center lg:text-right" />
                           </div>
                           <div className="space-y-2">
                      ...
                      <div className="space-y-6">
                         <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="space-y-2">
                               <Label className="text-[11px] font-black uppercase text-primary pr-4"><User size={14} className="inline ml-2" /> الاسم الكامل</Label>
