        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 md:gap-4 px-5 md:px-8 py-2 md:py-2.5 bg-card border border-primary/15 rounded-full backdrop-blur-md shadow-sm">
               ...
               <span className="text-[8px] md:text-[10px] font-black uppercase tracking-[0.2em] md:tracking-[0.3em] text-primary/80">
            ...
            <p className="text-base md:text-2xl text-muted-foreground max-w-3xl mx-auto font-medium leading-relaxed italic opacity-70 border-r-2 border-primary/20 pr-4 md:pr-8">
            ...
            <div className="flex flex-wrap justify-center gap-4 md:gap-8 pt-6 md:pt-10">
              <Button asChild className="royal-button h-16 md:h-20 px-10 md:px-16 text-sm md:text-lg shadow-xl shadow-primary/15 hover:scale-105 transition-all">
                <Link href="/store">دخول المستودع</Link>
              </Button>
              <Button asChild variant="outline" className="h-16 md:h-20 px-10 md:px-16 rounded-[1.5rem] md:rounded-[1.75rem] border-primary/20 hover:bg-primary/5 font-black text-[10px] md:text-xs uppercase tracking-widest gap-3 md:gap-4 transition-all">
      ...
      {products && products.length > 0 && (
        <section className="py-20 md:py-40 bg-muted/10 border-y relative overflow-hidden">
          <div className="container mx-auto px-6 relative z-10">
            <div className="flex flex-col md:flex-row items-center justify-between mb-16 md:mb-24 gap-6 md:gap-8">
              <div className="text-center md:text-right">
                <h2 className="text-4xl md:text-7xl font-headline font-black flex items-center justify-center md:justify-start gap-4 md:gap-6 uppercase">
                  باقات <span className="gold-text">النخبة</span>
                </h2>
                <p className="text-muted-foreground font-black text-[8px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] mt-2 md:mt-4 opacity-50">Elite Sovereign Selection</p>
              </div>
              <Button asChild variant="ghost" className="text-primary font-black uppercase text-[8px] md:text-[10px] tracking-[0.2em] md:tracking-[0.3em] hover:bg-primary/10 px-6 md:px-8 h-12 md:h-14 rounded-xl border border-primary/10">
      ...
      <section className="py-24 md:py-48 relative overflow-hidden bg-background">
        <div className="container mx-auto px-6">
           <div className="text-center mb-16 md:mb-24 space-y-2 md:space-y-4">
              <h2 className="text-4xl md:text-[5rem] font-headline font-black uppercase tracking-tighter"><span className="gold-text">ما يميزنا</span></h2>
              <p className="text-muted-foreground uppercase font-black text-[8px] md:text-[10px] tracking-[0.4em] md:tracking-[0.6em] opacity-30">The Sovereign Excellence Protocol</p>
           </div>
